...
Core should keep stable: `magick-ai/approve-comment`.
...
- discovering `magick-ai/approve-comment` through ability intake;
...
- `magick-ai/approve-comment` is discoverable from `magick-ai-abilities`;
