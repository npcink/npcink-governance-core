...
EXPECTED_ADAPTER_VERSION="${EXPECTED_ADAPTER_VERSION:-0.3.1}"
EXPECTED_TOOLKIT_VERSION="${EXPECTED_TOOLKIT_VERSION:-0.5.1}"
...
Environment overrides:
  ...
  EXPECTED_ADAPTER_VERSION        Default: 0.3.1.
  EXPECTED_TOOLKIT_VERSION        Default: 0.5.1.
